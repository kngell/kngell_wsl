...
$this->start('head'); ?>
<!-------Costum-------->
<meta name="csrftoken" content="<?=$this->token->generate_token(8, 'all_posts_page')?>" />
<link href="<?= $this->asset('css/custom/backend/admin/posts/allposts', 'css') ?? ''?>" rel="stylesheet"
    type="text/css">
...
<main id=main-site>
    ...
    <div class="page-content">
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="card card-solid" id="allposts-wrapper">
                    <div id="alertErr"></div>
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php require_once 'partials/_post_form.php'?>
                </div>
            </div>
        </div>
    </div>
...
<!----------custom--------->
<script type="text/javascript" src="<?= $this->asset('js/custom/backend/admin/posts/allposts', 'js') ?? ''?>">
</script>
<?php $this->end();